...
try:
    ...
    #          print("发布成功")
    #          break
    ele = driver.find_element_by_id("android:id/list")
    locationA = ele.location  #左上角的坐标
    sizeA = ele.size
    print(locationA,sizeA)
    # {'x': 0, 'y': 288} {'height': 2083, 'width': 1440}
    x1 = int (sizeA["width"])*0.5
    y1 = int(sizeA["height"])+locationA["y"]*0.8
    y2 = locationA["y"]*2
    for i in range(10):
        # driver.swipe(start_x=720, start_y=2200, end_x=720, end_y=500, duration=500)
